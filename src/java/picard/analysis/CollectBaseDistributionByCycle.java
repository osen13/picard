...
public class CollectBaseDistributionByCycle extends SinglePassSamProgram {
        ...
        static final String USAGE_DETAILS = "This program charts the nucleotide distribution per cycle in a SAM or BAM file.<br /><br />" +
            ...
            " unassigned nucleotides (N) in a read.  Using the CollectBaseDistributionByCycle tool, increased numbers of miscalled bases will be reflected" +
            " in base distribution changes as well as an increase in the number of \"N\"s." +
            "  Thus, using this tool, the user can visually determine which cycles to use (or not use) in downstream analyses." +
            "<br />" +
            "<h4>Usage example:</h4>" +
            "<pre>" +
